...
class AuthCodeService
{
    ...
    public function get_access_token_from_refresh_token($client_id, $client_secret, $refresh_token)
    {
        try {
            ...
            $response = $this->post_for_token_info(
                AuthCodeConstants::REFRESH_TOKEN_URL,
                $body,
                $client_id,
                $client_secret
            );
    ...
    public function api_response($response)
    {
        ...
        if (isset($json->access_token)) {
            ...
            return (new UpsOauthResponse($token_info, null))->toArray();
        }
    ...
    public function api_error_response($json_data)
    {
        ...
        return (new UpsOauthResponse(null, $api_error_info))->toArray();
    }

    public function login_response($redirect_uri)
    {
        $login_info = new LoginInfo($redirect_uri);
        return (new UpsOauthResponse($login_info->toArray(), null))->toArray();
    }
    ...
    public function login_error_response($json_data)
    {
        ...
        return (new UpsOauthResponse(null, $login_error_info))->toArray();
    }
